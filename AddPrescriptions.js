...
const AddPrescription = ({ user }) => {
  ...
  // Keep the original links list from AddPrescription component
  const links = [
  ...
  return (
    <div className="recentCustomers" style={{ 
      ...
      {loading && <p style={{ textAlign: "center" }}>Loading patient data...</p>}
            ...
            <div>
              ...
              <p>
                ...
                <span style={highlightCondition(healthData.cholesterol, "cholesterol")}>
                  {healthData.cholesterol ? `${healthData.cholesterol} mg/dL` : "N/A"}
                </span>
              </p>
              <p>
